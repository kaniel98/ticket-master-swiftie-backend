...
@Data
@Builder
public class TicketingOfficerBookingTicketRequest {
    @NotNull(message = "ID of the ticketing officer who is booking the ticket is required")
    ...
    @Schema(description = "Ticket's email", example = "001")
